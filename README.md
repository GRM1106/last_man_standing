...
2. Run `supabase/fix_google_names.sql`, `supabase/admin_setup.sql`, `supabase/pot_setup.sql`, `supabase/player_dashboard_setup.sql`, `supabase/pot_gameweek_schedule.sql`, `supabase/fix_multiple_player_pots.sql`, then `supabase/fpl_fixture_setup.sql` in that order.
